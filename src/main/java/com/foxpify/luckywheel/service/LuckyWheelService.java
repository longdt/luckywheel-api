...
public interface LuckyWheelService {
    ...
    default Future<Void> createWheelGui(Long tokenId) {
        return Futures.toFuture(this::createWheelGui, tokenId);
    }

    void createWheelGui(Long tokenId, Handler<AsyncResult<Void>> resultHandler);
